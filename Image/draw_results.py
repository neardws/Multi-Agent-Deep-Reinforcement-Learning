...
def draw_loss(given_list_file_name):
    correct_list_file_name = project_dir + data + given_list_file_name
    list_file = load_obj(name=correct_list_file_name)
    ...
    plt.legend(loc="best")  # 图例
    plt.subplot(613)
    plt.plot(epoch_index, actor_loss_of_edge, '-', color='lightgreen')
    plt.subplot(614)
    plt.plot(epoch_index, critic_loss_of_edge, '-', color='blueviolet')
    plt.subplot(615)
    plt.plot(epoch_index, actor_loss_of_reward, '-', color='lightgreen')
    plt.subplot(616)
    plt.plot(epoch_index, critic_loss_of_reward, '-', color='blueviolet')
    plt.show()
...
def draw_loss_of_edge(given_list_file_name):
    correct_list_file_name = project_dir + data + given_list_file_name
    list_file = load_obj(name=correct_list_file_name)
    csv_file_name = load_name(list_file, 'temple_loss_name')
    df = pd.read_csv(csv_file_name, names=["Epoch index",
...
def draw_loss_of_reward(given_list_file_name):
    correct_list_file_name = project_dir + data + given_list_file_name
    list_file = load_obj(name=correct_list_file_name)
    csv_file_name = load_name(list_file, 'temple_loss_name')
    df = pd.read_csv(csv_file_name, names=["Epoch index",
...
if __name__ == '__main__':
    ...
    file_name = '2021-08-31-07-23-38-list_file_name.pkl'
    ...
    draw_loss_of_edge(given_list_file_name=file_name)
    draw_loss_of_reward(given_list_file_name=file_name)
