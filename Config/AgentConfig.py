...
class AgentConfig(object):
    ...
    def config(
        ...
        actor_experience_replay_buffer_batch_size=128,
        ...
        critic_experience_replay_buffer_batch_size=128,
        ...
        actor_reward_replay_buffer_batch_size=128,
        ...
        critic_reward_replay_buffer_batch_size=128,
