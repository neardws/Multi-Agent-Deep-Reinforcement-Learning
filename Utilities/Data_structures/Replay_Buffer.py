...
class Replay_Buffer(object):
    ...
    def __init__(self, buffer_size, batch_size, seed, device=None):
        ...
        """
        self.memory = deque(maxlen=buffer_size)  #  store all Experiences with ["state", "action", "reward", "next_state", "done"]
    ...
    def add_experience(self, states, actions, rewards, next_states, dones):
        ...
        :param dones: @TODO Fix the meaning
        :return: None
        """
        if type(dones) == list:
