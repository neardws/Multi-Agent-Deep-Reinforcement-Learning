...
@File    ：HDRSensorActorReplayBuffer.py
@Author  ：Neardws
...
class HDREdgeActorReplayBuffer(object):
    ...
    def add_experience(self, edge_node_observation, sensor_nodes_action):
        """
    ...
    def separate_out_data_types(self, experiences):
        ...
        return edge_node_observations, sensor_nodes_actions
