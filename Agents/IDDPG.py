...
class IDDPG_Agent(object):
    ...
    """
    Workflow of each step of IDDPG_Agent
    ...
    def save_actor_experience(self):
        ...
        if self.actor_experience_replay_buffer is None:
            raise Exception("experience_replay_buffer is None, function save_experience at IDDPG.py")
    ...
    def save_actor_reward_experience(self):
        if self.actor_reward_replay_buffer is None:
            raise Exception("reward_replay_buffer is None, function save_reward_experience at IDDPG.py")
        """Save as torch.Tensor"""
